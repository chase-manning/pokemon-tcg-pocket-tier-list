...
This tutorial explains how to fetch Limitless tournament data and run the analysis pipeline locally. You need **Node.js 24.18.1**, the version the CI workflows pin, and **Yarn** installed on your system.
